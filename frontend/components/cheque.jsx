...
const CreateForms = () => {
  ...
  const [chequeSavingsAccountId, setChequeSavingsAccountId] = useState('');
  ...
  const handleChequeSubmit = async (e) => {
    ...
    const chequeData = {
      savingsAccountId: parseInt(chequeSavingsAccountId, 10),
      name: chequeName,
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleChequeSubmit} className='bg-white'>
                <div className="form-group">
                  <label htmlFor="chequeSavingsAccountId" className="font-weight-bold text-dark">Account ID</label>
                  <input
                    type="number"
                    id="chequeSavingsAccountId"
                    className="form-control"
                    value={chequeSavingsAccountId}
                    onChange={(e) => setChequeSavingsAccountId(e.target.value)}
                    required
                  />
                </div>
                <div className="form-group">
