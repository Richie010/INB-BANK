...
const navigation = [
    ...
    { name: 'Savings Accounts Approval', href: '/PendingAproval', icon: FolderIcon, current: false },
    { name: 'Current Accounts Approval', href: '/currentPending', icon: FolderIcon, current: false },
    { name: 'Blocked Login', href: '/LockBlocked', icon: LockClosedIcon, current: false },
    { name: 'Cheque Deposit Approval', href: '/ChequeApprove', icon: DocumentDuplicateIcon, current: false },
    { name: 'Cheque List', href: '/chequelist', icon: DocumentDuplicateIcon, current: false },
];
