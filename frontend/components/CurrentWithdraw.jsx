...
export function WithdarwCurrent() {
    ...
    let handleSubmit = (event) => {
        ...
        let store_url = `http://localhost:8082/currentaccount/${accountId}/${password}/withdraw`;
        axios.post(store_url, { "amount": amount })
            .then(s => {
                console.log(s);
                setMessage(`Withdraw Success!  Balance is: ${s.data.balance}`);
                setSuccess(true);
                clearForm();
            }).catch(e => {
                console.log(e);
